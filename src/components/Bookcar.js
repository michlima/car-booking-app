...
const Bookcar = (props) => {
    ...
    return(
        <div className='flex items-center flex-col w-screen'>
            ...
            <button onClick={() => props.bookTimeF(data)} className='duration-200 w-16 h-16 bg-red-400 mb-10 flex items-center hover:text-3xl hover:w-12 hover:h-12 hover:text-white justify-center rounded-full'>
                <FaCheck/>
            </button>
        </div>
    )
